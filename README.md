...
Desenvolvedor back-end com experiência em Java e Go, focado em construção de APIs REST, autenticação JWT/2FA e sistemas administrativos escaláveis. Tenho vivência com integração de bancos de dados relacionais (MySQL e PostgreSQL), automações fiscais e aplicações full stack com React.

Atualmente em transição para uma posição de desenvolvedor júnior — com projetos reais em produção e foco em boas práticas de código.
...
[![LinkedIn](https://img.shields.io/badge/LinkedIn-joaopedrogarciagonzaga-0077B5?style=flat-square&logo=linkedin)](https://www.linkedin.com/in/joaopedrogarciagonzaga)
[![Gmail](https://img.shields.io/badge/Gmail-jjooaaoo46@gmail.com-D14836?style=flat-square&logo=gmail&logoColor=white)](mailto:jjooaaoo46@gmail.com)
